...
def RegHive(subcon):
    ...
    'HKCU'
    """
    return malstruct.Enum(subcon, **REGHIVES)
...
def LanguageIdentifier(subcon):
    ...
    'Chinese (PRC)'
    """
    return malstruct.Enum(subcon, **LANGUAGEIDENTIFIERS)
...
def KnownFolderID(subcon):
    ...
    """
    return malstruct.Enum(subcon, **CSIDL)
...
def AlgorithmID(subcon):
    ...
    b'\x01h'
    """
    return malstruct.Enum(subcon, **ALGIDS)
