...
from malstruct.utils.windows_structures import *
...
class DataDirectories(malstruct.ListContainer):
    ...
    def sizeof(self):
        return IMAGE_DATA_DIRECTORY.sizeof() * len(self)

    # Provide convenience properties for accessing standard data directories.

    @property
    def exports(self):
        return self[DATA_DIR_INDEX_EXPORTS]

    @exports.setter
    def exports(self, value):
        self[DATA_DIR_INDEX_EXPORTS] = value

    @property
    def imports(self):
        return self[DATA_DIR_INDEX_IMPORTS]

    @imports.setter
    def imports(self, value):
        self[DATA_DIR_INDEX_IMPORTS] = value

    @property
    def resource(self):
        return self[DATA_DIR_INDEX_RESOURCE]

    @resource.setter
    def resource(self, value):
        self[DATA_DIR_INDEX_RESOURCE] = value

    @property
    def exception(self):
        return self[DATA_DIR_INDEX_EXCEPTION]

    @exception.setter
    def exception(self, value):
        self[DATA_DIR_INDEX_EXCEPTION] = value

    @property
    def certificate(self):
        return self[DATA_DIR_INDEX_CERTIFICATE]

    @certificate.setter
    def certificate(self, value):
        self[DATA_DIR_INDEX_CERTIFICATE] = value

    @property
    def base_reloc(self):
        return self[DATA_DIR_INDEX_BASE_RELOC]

    @base_reloc.setter
    def base_reloc(self, value):
        self[DATA_DIR_INDEX_BASE_RELOC] = value

    @property
    def debug(self):
        return self[DATA_DIR_INDEX_DEBUG]

    @debug.setter
    def debug(self, value):
        self[DATA_DIR_INDEX_DEBUG] = value

    @property
    def architecture(self):
        return self[DATA_DIR_INDEX_ARCHITECTURE]

    @architecture.setter
    def architecture(self, value):
        self[DATA_DIR_INDEX_ARCHITECTURE] = value

    @property
    def global_ptr(self):
        return self[DATA_DIR_INDEX_GLOBAL_PTR]

    @global_ptr.setter
    def global_ptr(self, value):
        self[DATA_DIR_INDEX_GLOBAL_PTR] = value

    @property
    def tls(self):
        return self[DATA_DIR_INDEX_TLS]

    @tls.setter
    def tls(self, value):
        self[DATA_DIR_INDEX_TLS] = value

    @property
    def load_config(self):
        return self[DATA_DIR_INDEX_LOAD_CONFIG]

    @load_config.setter
    def load_config(self, value):
        self[DATA_DIR_INDEX_LOAD_CONFIG] = value

    @property
    def bound_import(self):
        return self[DATA_DIR_INDEX_BOUND_IMPORT]

    @bound_import.setter
    def bound_import(self, value):
        self[DATA_DIR_INDEX_BOUND_IMPORT] = value

    @property
    def import_address(self):
        return self[DATA_DIR_INDEX_IMPORT_ADDRESS]

    @import_address.setter
    def import_address(self, value):
        self[DATA_DIR_INDEX_IMPORT_ADDRESS] = value

    @property
    def dely_import_descriptor(self):
        return self[DATA_DIR_INDEX_DELAY_IMPORT_DESCRIPTOR]

    @dely_import_descriptor.setter
    def dely_import_descriptor(self, value):
        self[DATA_DIR_INDEX_DELAY_IMPORT_DESCRIPTOR] = value

    @property
    def clr_header(self):
        return self[DATA_DIR_INDEX_CLR_HEADER]

    @clr_header.setter
    def clr_header(self, value):
        self[DATA_DIR_INDEX_CLR_HEADER] = value
...
class PE(Container):
    ...
    def __init__(self, data=None, is_64bit=False):
        ...
        if is_64bit:
            ...
            _characteristics.append(IMAGE_FILE_32BIT_MACHINE)
        ...
        _file_header = Container({
            ...
            'NumberOfSymbols': 0,
            'SizeOfOptionalHeader': IMAGE_OPTIONAL_HEADER.sizeof(**_optional_header),
    ...
    def _fix_section(self, section):
        ...
        if not section_copy.Characteristics:
            ...
            if section_copy.Name == u'.text':
                _characteristics += [IMAGE_SCN_CNT_CODE, IMAGE_SCN_MEM_EXECUTE]
            else:
                _characteristics += [IMAGE_SCN_CNT_INITIALIZED_DATA]
            if section_copy.Name == u'.data':
                _characteristics += [IMAGE_SCN_MEM_WRITE]
            if section_copy.Name == u'.reloc':
                _characteristics += [IMAGE_SCN_MEM_DISCARDABLE]
    ...
    def build(self, write_section_data=True):
        ...
        dos_stub_size = pe.DosHeader.e_lfanew - IMAGE_DOS_HEADER.sizeof()
        ...
        file_header.SizeOfOptionalHeader = IMAGE_OPTIONAL_HEADER.sizeof(**optional_header)
        ...
        headers_size = PEFILE_HEADER.sizeof(**pe)
        ...
        pe_data = PEFILE_HEADER.build(pe)

        # Add section data.
        if write_section_data:
            stream = io.BytesIO(pe_data)
            spec = malstruct.Pointer(this.PointerToRawData, malstruct.Bytes(this.SizeOfRawData))
            for section in pe.SectionTable:
